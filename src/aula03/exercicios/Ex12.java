...
public class Ex12 {
	public static void main(String[] args) {
		...
		System.out.print("Qual a área de aberturas: ");
		float areaAberturas = ler.nextFloat();
		float areaTotal = comprimento*altura*2 + largura*altura*2;
		//areaTotal = 2*(comprimento*altura+largura+altura);
		...
		System.out.printf("Para cobrir os %.2f m² de parede serão necessárias " +
						"%.2f caixas de azulejos\n",areaTotal,quantCaixas);
	}
}
